...
:class:`~eeg_win_stack.api.backends.Job`, hand it to the selected
:class:`~eeg_win_stack.api.backends.Backend`, and report the result. All the real
work lives in :mod:`eeg_win_stack.api` — this module only translates argv into a
...
def cmd_train(args: argparse.Namespace) -> dict:
    ...
    :func:`eeg_win_stack.api.jobs.run_training`, reached via the backend.
    """
