"""Tests for the model registry and factory (eeg_win_stack/models/factory.py)."""

from __future__ import annotations

import pytest

from eeg_win_stack.models import factory
from eeg_win_stack.models.factory import ModelFactory, register
