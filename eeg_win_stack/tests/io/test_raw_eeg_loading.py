"""Tests for RawEEGLoader and custom_crop (eeg_win_stack/io/raw_eeg_loading.py)."""

from __future__ import annotations

from unittest.mock import MagicMock, patch

from eeg_win_stack.io.raw_eeg_loading import RawEEGLoader, custom_crop
...
class TestLoad:
    @patch("eeg_win_stack.io.raw_eeg_loading.BaseConcatDataset")
    @patch("eeg_win_stack.io.raw_eeg_loading.TUHAbnormal")
    ...
    @patch("eeg_win_stack.io.raw_eeg_loading.remove_tuab_from_dataset")
    @patch("eeg_win_stack.io.raw_eeg_loading.BaseConcatDataset")
    @patch("eeg_win_stack.io.raw_eeg_loading.TUH")
    @patch("eeg_win_stack.io.raw_eeg_loading.TUHAbnormal")
...
class TestFilter:
    def _patches(self):
        return (
            patch("eeg_win_stack.io.raw_eeg_loading.select_by_duration"),
            patch("eeg_win_stack.io.raw_eeg_loading.exclude_by_undefined_pathology"),
            patch("eeg_win_stack.io.raw_eeg_loading.select_by_channel"),
            patch("eeg_win_stack.io.raw_eeg_loading.relabel"),
        )
...
class TestPreprocessRecordings:
    @patch("eeg_win_stack.io.raw_eeg_loading.preprocess")
    ...
    @patch("eeg_win_stack.io.raw_eeg_loading.Preprocessor")
    @patch("eeg_win_stack.io.raw_eeg_loading.preprocess")
...
class TestSaveAsBrainvision:
    @patch("eeg_win_stack.io.raw_eeg_loading.mne")
