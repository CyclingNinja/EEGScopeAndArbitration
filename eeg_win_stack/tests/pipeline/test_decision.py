"""Tests for the decision DVC stage (eeg_win_stack/pipeline/decision.py)."""
...
from eeg_win_stack.pipeline import decision as decision_stage
...
def test_stage_writes_all_outputs_under_target(stage_config, training_detail_csv):
    ...
    with patch("eeg_win_stack.pipeline.decision.load", return_value=stage_config):
        decision_stage.main()
