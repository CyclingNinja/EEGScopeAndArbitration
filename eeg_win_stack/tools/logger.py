...
``eeg_win_stack`` logger and every module logs through a child of it.
...
class Logger:
    """A named logger within the ``eeg_win_stack`` hierarchy.
    ...
    name : str, optional
        ...
        re-parented under ``eeg_win_stack``. Defaults to the package root.
